...
_lr_productions = [
  ...
  ('program -> PROGRAM_ID ID SEMICOLON vars functions block','program',6,'p_expression_program_vars','parser.py',14),
  ('block -> OPEN_BRACKET block_statue CLOSE_BRACKET','block',3,'p_block','parser.py',20),
  ('block_statue -> statue block_statue','block_statue',2,'p_block_statue','parser.py',27),
  ('block_statue -> empty','block_statue',1,'p_block_statue','parser.py',28),
  ('statue -> assign','statue',1,'p_statue','parser.py',35),
  ('statue -> condition','statue',1,'p_statue','parser.py',36),
  ('statue -> write','statue',1,'p_statue','parser.py',37),
  ('statue -> return','statue',1,'p_statue','parser.py',38),
  ('vars -> VAR_ID varstype vars2','vars',3,'p_vars','parser.py',45),
  ('vars2 -> varstype vars2','vars2',2,'p_vars','parser.py',46),
  ('vars2 -> empty','vars2',1,'p_vars','parser.py',47),
  ('varstype -> ID varstype2 COLON type SEMICOLON','varstype',5,'p_vars','parser.py',48),
  ('varstype2 -> COMMA ID varstype2','varstype2',3,'p_vars','parser.py',49),
  ('varstype2 -> empty','varstype2',1,'p_vars','parser.py',50),
  ('functions -> FUNCTION_ID type ID OPEN_PARENTHESIS parameters CLOSE_PARENTHESIS block','functions',7,'p_functions','parser.py',56),
  ('functions -> empty','functions',1,'p_functions','parser.py',57),
  ('parameters -> type ID parameters2','parameters',3,'p_parameters','parser.py',63),
  ('parameters -> empty','parameters',1,'p_parameters','parser.py',64),
  ('parameters2 -> COMMA type ID parameters2','parameters2',4,'p_parameters','parser.py',65),
  ('parameters2 -> empty','parameters2',1,'p_parameters','parser.py',66),
  ('assign -> ID EQUAL expression SEMICOLON','assign',4,'p_assign','parser.py',72),
  ('exp -> term plus_minus','exp',2,'p_exp','parser.py',79),
  ('term -> factor multiply_divide','term',2,'p_term','parser.py',85),
  ('factor -> OPEN_PARENTHESIS expression CLOSE_PARENTHESIS','factor',3,'p_factor','parser.py',91),
  ('factor -> plus_minus_factor var_cte','factor',2,'p_factor','parser.py',92),
  ('var_cte -> ID','var_cte',1,'p_var_cte','parser.py',98),
  ('var_cte -> INT','var_cte',1,'p_var_cte','parser.py',99),
  ('var_cte -> FLOAT','var_cte',1,'p_var_cte','parser.py',100),
  ('plus_minus_factor -> PLUS','plus_minus_factor',1,'p_plus_minus_factor','parser.py',106),
  ('plus_minus_factor -> MINUS','plus_minus_factor',1,'p_plus_minus_factor','parser.py',107),
  ('plus_minus_factor -> empty','plus_minus_factor',1,'p_plus_minus_factor','parser.py',108),
  ('multiply_divide -> MULTIPLY term','multiply_divide',2,'p_multiply_divide','parser.py',114),
  ('multiply_divide -> DIVIDE term','multiply_divide',2,'p_multiply_divide','parser.py',115),
  ('multiply_divide -> empty','multiply_divide',1,'p_multiply_divide','parser.py',116),
  ('plus_minus -> PLUS exp','plus_minus',2,'p_plus_minus','parser.py',122),
  ('plus_minus -> MINUS exp','plus_minus',2,'p_plus_minus','parser.py',123),
  ('plus_minus -> empty','plus_minus',1,'p_plus_minus','parser.py',124),
  ('condition -> IF OPEN_PARENTHESIS expression CLOSE_PARENTHESIS block else SEMICOLON','condition',7,'p_condition','parser.py',130),
  ('else -> ELSE block','else',2,'p_condition_else','parser.py',136),
  ('else -> empty','else',1,'p_condition_else','parser.py',137),
  ('expression -> exp expression_def','expression',2,'p_expression','parser.py',143),
  ('expression_def -> GREATER_THAN exp','expression_def',2,'p_expression','parser.py',144),
  ('expression_def -> GREATER_THAN_EQUAL exp','expression_def',2,'p_expression','parser.py',145),
  ('expression_def -> LESS_THAN exp','expression_def',2,'p_expression','parser.py',146),
  ('expression_def -> LESS_THAN_EQUAL exp','expression_def',2,'p_expression','parser.py',147),
  ('expression_def -> NOT_EQUAL exp','expression_def',2,'p_expression','parser.py',148),
  ('expression_def -> empty','expression_def',1,'p_expression','parser.py',149),
  ('return -> RETURN_ID expression SEMICOLON','return',3,'p_return','parser.py',155),
  ('write -> PRINT OPEN_PARENTHESIS write_exp CLOSE_PARENTHESIS SEMICOLON','write',5,'p_write','parser.py',161),
  ('write_exp -> expression','write_exp',1,'p_write_exp','parser.py',167),
  ('write_exp -> expression COMMA write_exp','write_exp',3,'p_write_exp','parser.py',168),
  ('write_exp -> STRING','write_exp',1,'p_write_exp','parser.py',169),
  ('write_exp -> STRING COMMA write_exp','write_exp',3,'p_write_exp','parser.py',170),
  ('type -> INT_ID','type',1,'p_type','parser.py',176),
  ('type -> FLOAT_ID','type',1,'p_type','parser.py',177),
